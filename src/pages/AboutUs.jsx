    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                La aplicación web cuenta con dos herramientas para el emprendedor, una de ellas es el lienzo de modelo de negocios canvas y otra el cronograma de actividades. Las tecnologías usadas para el desarrollo de esta aplicación son React.js (front-end) una de las librerías más populares en la actualidad y laravel para garantizar la seguridad y proveedor de las APIs en el backend.</p>
